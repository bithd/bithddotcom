...
export function Partners() {
  ...
  const partners: ImgLink[] = [
    ...
    {
      img: isCN(i18n.language)
        ? "/images/poolin_cn.png"
        : "/images/poolin_en.png",
    ...
    {
      img: isCN(i18n.language)
        ? "/images/chainnode_cn.png"
        : "/images/chainnode_en.png",
      link: "https://www.chainnode.com/",
    },
    {
      img: isCN(i18n.language)
        ? "/images/whaleex_cn.png"
        : "/images/whaleex_en.png",
      link: "https://www.whaleex.com/",
    },
    {
      img: isCN(i18n.language)
        ? "/images/coinbull_cn.png"
        : "/images/coinbull_en.png",
      link: "https://www.coinbull.one/",
    },
    {
      img: isCN(i18n.language)
        ? "/images/randomnumber_cn.png"
        : "/images/randomnumber_en.png",
      link: "",
    },
    {
      img: isCN(i18n.language)
        ? "/images/dextop_cn.png"
        : "/images/dextop_en.png",
      link: "https://dex.top/home",
    },
    {
      img: isCN(i18n.language)
        ? "/images/newdex_cn.png"
        : "/images/newdex_en.png",
          ...
          <>
            {partners.map((item, index) => {
              return (
                <a
                  key={index}
                  href={item.link.length > 0 ? item.link : "javascript:void(0)"}
